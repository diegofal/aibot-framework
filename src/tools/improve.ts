...
function buildClaudePrompt(
  ...
  const parts = [
    ...
    '',
    'The default bot\'s files live directly in the root:',
    ...
    '',
    'Each additional bot has its own subdirectory (e.g. Therapist/) with the same structure.',
    'Use Glob to discover all subdirectories: ' + absDir + '/**/IDENTITY.md',
