...
const mockLogger = {
  debug: (...args: any[]) => {
    logMessages.push({ level: 'debug', msg: args[1] ?? '', data: args[0] });
  },
  info: (...args: any[]) => {
    logMessages.push({ level: 'info', msg: args[1] ?? '', data: args[0] });
  },
  warn: (...args: any[]) => {
    logMessages.push({ level: 'warn', msg: args[1] ?? '', data: args[0] });
  },
  error: (...args: any[]) => {
    logMessages.push({ level: 'error', msg: args[1] ?? '', data: args[0] });
  },
  child: () => mockLogger,
  level: 'debug',
  fatal: () => {},
